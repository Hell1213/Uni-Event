...
import { validate, validateAndAddDoc, validateAndSetDoc, validateAndUpdateDoc, eventUpdateSchema, bookmarkSchema, viewSchema, reminderSchema } from '../lib/validators';
...
export default function EventDetail({ route, navigation }) {
    ...
    const handleSubmitAppeal = async ({ subject, message }) => {
        ...
        try {
            await validateAndUpdateDoc(doc(db, 'events', event.id), {
        ...
        const recordView = async () => {
            ...
            try {
                ...
                if (!viewSnap.exists()) {
                    ...
                    await validateAndSetDoc(viewRef, {
    ...
    const toggleBookmark = async () => {
        ...
        try {
            ...
            if (isBookmarked) {
                ...
                await validateAndSetDoc(bookmarkRef, {
                    eventId: eventId,
    ...
    const toggleReminder = async () => {
        ...
        try {
            ...
            if (reminderId) {
                ...
                if (notifId) {
                    const docRef = await validateAndAddDoc(collection(db, 'reminders'), {
                        userId: user.uid,
                        eventId: event.id,
